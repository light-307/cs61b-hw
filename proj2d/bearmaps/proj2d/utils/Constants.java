...
public class Constants {
    ...
    public static final String OSM_DB_PATH = "./cs61b-hw/library-fa20/data/proj2d_xml/berkeley-2019.osm.xml";

    /** The tile images are in the IMG_ROOT folder. */
    //public static final String IMG_ROOT = "../library-fa20/data/proj2d_imgs/";
    public static final String IMG_ROOT = "./cs61b-hw/library-fa20/data/proj2d_imgs/";
