...
//    private static final String PARAMS_FILE = "../library-fa20/data/proj2d_test_inputs/path_params.txt";
    private static final String PARAMS_FILE = "./cs61b-hw/library-fa20/data/proj2d_test_inputs/path_params.txt";
//    private static final String RESULTS_FILE = "../library-fa20/data/proj2d_test_inputs/path_results.txt";
    private static final String RESULTS_FILE = "./cs61b-hw/library-fa20/data/proj2d_test_inputs/path_results.txt";
    private static final int NUM_TESTS = 8;
//    private static final String OSM_DB_PATH = "../library-fa20/data/proj2d_xml/berkeley-2019.osm.xml";
    private static final String OSM_DB_PATH = "./cs61b-hw/library-fa20/data/proj2d_xml/berkeley-2019.osm.xml";
